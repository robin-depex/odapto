...
<?php
    ...
    $query = "SELECT * FROM  chat_login_details WHERE user_id = '".$_SESSION['user_id']."' ";
        ...
        <div class="row">
				...
				<div class="col-md-2 col-sm-3">
					<!--<p align="right">Hi - <?php echo $_SESSION['username']; ?> - <a href="logout.php">Logout</a></p> -->
					 ...
					 <h4><a href="dashboard.php?page=live_chat" class="btn btn-info">Online User</a></h4>
				</div> 
			</div>
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"live_chat/fetch_all_users.php",
			method:"POST",
