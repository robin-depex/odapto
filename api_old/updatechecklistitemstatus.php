...
$item_status = $arr['RequestData']['item_status'];
...
$checkarry[] = $data_check;
  ...
  $response = array(
                "successBool" => true,
                "responseType" => "update_checklist_item_status",
                "successCode" => "200",
                    "response" => array(
                        "updatechecklistitemstatus" => $checkarry,
                        "message" => 'Checkist item status update successfully',
                    ),
                    "ErrorObj"   => array(
                        "ErrorCode" => "",
                        "ErrorMsg"  => ""
