...
$intriget_type = $arr['RequestData']['intriget_type'];
...
$insertarray = array(
$intriget_type => $status,
	);

$updatedata = $db->update('tbl_users',$insertarray,$wherarraycheck);


  $response = array(
                "successBool" => true,
                "responseType" => "update_integration",
                "successCode" => "200",
                    "response" => array(
