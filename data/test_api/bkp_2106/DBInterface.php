...
return $url;
    ...
    public function chkLogin($emailid,$passwd,$type,$dev_id){
        ...
        if($query_result['status'] == "1"){
            ...
            $update_data = array("token" => $token,'add_date' => $date,'status'=>1);
    ...
    function userLogout($username,$password,$dev_id,$dev_type){
        $query = "select ID from tbl_users where Email_ID = '$username' and User_Password = '$password' ";
        $result = mysqli_query($this->dbh,$query);
