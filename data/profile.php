...
<div class="col-sm-6 col-sm-offset-3">
  ...
  //print_r($user_data['profile_pics']); 
  if(!empty($_SESSION['FBID']) AND empty($user_data['profile_pics'])){
    $profile_img = "https://graph.facebook.com/".$_SESSION['FBID']."/picture?type=large";
    $display = "none";
  }
  elseif (!empty($user_data['profile_pics'])) {
  ...
  <div class="col-sm-3" style="position:relative;padding: 0px;">
    ...
    <img src="<?php echo $profile_img; ?>" style="width:136px;height: 136px;">


    <div style="position: absolute;bottom: 0px; right: 0px; width:100%; background: rgba(0,0,0,0.5); text-align: center;padding:8px;display: <?php echo $display; ?>"><a href="javascript:void(0)" onclick="return ShowAddProfile()"> Change </a></div>
    ...
    <div class="col-md-12 b-s popup-container" id="AddProfile" style="">
      ...
      <div class="col-sm-12">
         ...
         <input type="file" class="form-control input-md" name="user" id="file">
      </div>
      <div class="col-sm-12">
         <input type="button" class="list-btn btn-block btn-md" name="uploadPics" id="imguplaod" value="UploadProfile">
      </div>  
  ...
  <h4 style="color:#FFF"> <?php echo $_SESSION['fullname']; ?>
    <span style="font-size: 14px;">
    <?php echo trim($result['user_name']); ?></span>  
  </h4>
  <?php if(!empty($result['Bio'])){ ?>
  <p id="bio"><?php echo trim($result['Bio']); ?></p>
  <?php } ?>      
  <a onclick="return editprofile()" href="javascript:void(0)" class=" btn btn-success">Edit Profile</a>
  </div>
...
<form action="" method="profile" id="profileForm">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="initials" name="initials" value="<?php echo trim($result['intials']); ?>">
  </div>
  <div class="form-group">
  ...
  <div class="tab-content">
    ...
    <div id="home" class="tab-pane fade <?php echo $active. " " . $in; ?>">
      ...
      <div class="boardlist col-sm-12">
        ...
        <div class="col-sm-4">
          <a href="<?php echo SITE_URL."dashboard.php?page=board&b=$bid&t=$board_url&k=$board_key" ?>"> <i class="fa <?php echo $class; ?> top1"></i> <?php echo $Board_title; ?></a>   
        </div>
        <div class="col-sm-8">
    ...
    <div id="cards" class="tab-pane fade <?php echo $c_active. " ". $c_in; ?>">
      ...
      foreach ($boards as $values) {
        ...
        $board_url = SITE_URL."dashboard.php?page=board&b=$bid&t=$board_url&k=$board_key"; 
...
<div class="col-sm-4">
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="col-sm-4">
      <a style="margin-bottom:10px" class="btn btn-danger btn-block" id="pass_update">Update</a></div>
  </div>
      </div>
    </div>
    </div>
...
<div id="myModal-4" class="modal fade" role="dialog">
  <div class="modal-dialog modal-md">
    ...
    <div class="col-sm-4">
    <br />
      <a style="margin-bottom:10px" class="btn btn-danger btn-block" id="Change_email">Change Email</a></div>
  </div>
      </div>
    </div>
    </div>
...
$(".close-invite").click(function(event) {
 $("#cardModal,#renameBoardDiv").css({'display':'none'});
  ...
  function ShowAddProfile(){
    $("#AddProfile").css({'display':'block',"top":"0px","right":'0px'});
  } 
