...
if(isset($_REQUEST['data'])){
  ...
  //echo json_encode( $_REQUEST['data'] ); die();
	...
	$data_update = array("comments"=>$card_comment,"cardid"=>$card_id,"userid"=>$userid,"date_time"=>$date,"status"=>1,"ckey"=>$ckey);
	    ...
	    $member = $db->getBoardmembers($board_id);
					...
					foreach ($array as $value) {
						...
						if($senderid != $usr_id)
						{
                            ...
                            'notif_msg' => $name.' added a  new comment',
