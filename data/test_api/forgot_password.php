...
$email = $arr['RequestData']['user_email'];
...
if($status == 1){
	...
	$to = $email;
	$subject = "Change Password Email:: ".$companyName."";
	         
	$message = "<p>In order to change your account, Please Enter this code.";
	$message .= "<p>Verification Code: ".$fp_code." ";
