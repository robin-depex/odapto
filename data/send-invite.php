...
if($inv_type == "team"){
	...
	$insert = $db->insert("tbl_team_invite",$data);
	if($insert){
		
		$invite_link = SITE_URL."signup.php?page=team&b=".$bid."&t=".$burl."&k=".$bkey."&id=".$uid."&token=".$invtoken;
		echo $invite_link;
	}
}else{
	$data = array(
	...
	if($insert){
		...
		$invite_link = SITE_URL."signup.php?page=board&b=".$bid."&t=".$burl."&k=".$bkey."&id=".$uid."&token=".$invtoken;
		echo $invite_link;
	}
}
