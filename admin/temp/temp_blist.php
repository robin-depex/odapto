...
<div class="row">
  <div class="col col-xs-6">
    <h3 class="panel-title">Template Board List</h3>
  </div>
  <div class="col col-xs-6 text-right">
    <a href="<?php echo $add_temp; ?>" class="btn btn-sm btn-primary btn-create">
    <span class="fa fa-plus"></span> Add New Template Board List</a>
  </div>
</div>
</div>
        ...
        $.ajax({
            ...
            success:function(res){
                ...
                $(".poptext").text(obj.message);
                  var url = "<?php echo "https://odapto.com/admin/dashboard.php?page=temp_blist"; ?>";
