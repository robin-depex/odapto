...
$checkist_item_name = $arr['RequestData']['checkist_item_name'];
...
$insertdata = $db->insert('tbl_board_list_card_checklist_item',$insertarray);
    ...
    //dc code
	    ...
	    $name= $db->getName($uid);
            ...
            $members=$db->getBoardmembers($board_id);
                ...
                foreach ($array1 as $value1) {
                   ...
                   $where=array(
                      ...
                      $message= $name .' created a new Checklist item';
                                  $notification_type='create_check_list_item';
						     ...
						     if($user_token['push_token'])
                              {
                               ...
                               //insert in database
                                 $notify_data=array(
                                                'notif_title' =>  'New Checklist item Added',
                                                'notif_msg' => $message,
            ...
            $activity_data=array(
                    ...
                    'msg' => $name .' added a new  checklist item',
                     'board_id' => $board_id
                      );
