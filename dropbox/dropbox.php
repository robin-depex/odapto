...
'app_key' => "pn89jgplnlxfqbh",
'app_secret' => "0stu1wmkb5nimer",
...
$request_token = load_token($_GET['800shBlwaLAAAAAAAAAAEXzoqgGTX8SjdnCBnM6uM2bug7bD0_At96vc1VSHqK5-']);
if(empty($request_token)) die('Request token not found!');
// get & store access token, the request token is not needed anymore
$access_token = $dropbox->GetAccessToken($request_token);
store_token($access_token, "access");
delete_token($_GET['800shBlwaLAAAAAAAAAAEXzoqgGTX8SjdnCBnM6uM2bug7bD0_At96vc1VSHqK5-']);
}
