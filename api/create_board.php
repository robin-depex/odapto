...
if($teamId==0){
$board_data = array("admin_id"=>$uid,"team_id"=>$teamId,"board_title"=>$board_title,"board_key" => $rand ,"type"=>"PB","createDate"=>$date,"bg_img"=>$bg_img,"bg_color"=>$bg_color);
}else{
	$board_data = array("admin_id"=>$uid,"team_id"=>$teamId,"board_title"=>$board_title,"board_key" => $rand ,"type"=>"TB","createDate"=>$date,"bg_img"=>$bg_img,"bg_color"=>$bg_color);
}
