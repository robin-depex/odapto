...
//$pathhurl = 'https://odapto.com/confirmboard.php';
...
$insertpoint = $db->insert('tbl_share_board', $pointdata);


$referpath = $pathhurl.'?procode='.$promocode.'bid='.$board_id;
  $response = array(
                "successBool" => true,
                "responseType" => "share_board",
                "successCode" => "200",
                    "response" => array(
                      "message" => "Shared Board.",
                      "refer_url" => $referpath,
