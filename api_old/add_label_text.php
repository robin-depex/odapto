...
$insertdata = array("user_id"=>$user_id,"label_id"=>$label_id,"label_name"=>$label_name);

$insert = $db->insert("tbl_label_users",$insertdata);
if($insert){
	$response = array(
		"successBool" => true,
		"responseType" => "add_label_text",
		"successCode" => "200",
			"response" => array(
				'message' => "Add Label Text successfully"
			),
			"ErrorObj"	 => array(
				"ErrorCode" => "",
				"ErrorMsg"	=> ""
