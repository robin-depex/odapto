...
$id = $arr['RequestData']['comment_id'];
$comments = $arr['RequestData']['comment'];	
$list_data = array("comments"=>$comments);
$cond = array("id"=>$id);
$update_title = $db->update("tbl_board_list_card_comments",$list_data,$cond);
if($update_title){
	$response = array(
		"successBool" => true,
		"responseType" => "update_card_comment",
		"successCode" => "200",
			"response" => array(
