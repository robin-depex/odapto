...
$id = $arr['RequestData']['id'];	
$label_name = $arr['RequestData']['label_name'];	

$insertdata = array("label_name"=>$label_name);
$condition=array("id"=>$id);
$insert = $db->update("tbl_label_users",$insertdata,$condition);
if($insert){
	$response = array(
		"successBool" => true,
		"responseType" => "edit_label_text",
		"successCode" => "200",
			"response" => array(
				'message' => "Edit Label Text successfully"
			),
			"ErrorObj"	 => array(
				"ErrorCode" => "",
				"ErrorMsg"	=> ""
