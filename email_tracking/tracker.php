...
$from = "priya.depex64@gmail.com"; //sender's username
$pwd = "priya.depex"; //sender's password
//---------------------------SEND eMail------------------------------------------------
...
$mail->Host = "priya.depex64@gmail.com"; // SMTP server
...
$to = $_POST['email'];
$checkid = "Id:" . $id;
$fh = fopen("//d13dcw7qo4xgly.cloudfront.net/tutorial/php-email-tracker/email.txt", "r");
