...
if(!empty($_REQUEST['del'])){
    ...
    if(mysqli_query($con, $delete)){
      header("Location: admin.php?q=appointments");
    }
}
?>
<!DOCTYPE html>
...
<ul class="header-ul">
<li class="dropdown">
<a class="dropdown-toggle" data-toggle="dropdown" href="admin.php"><?php echo value('contactor_name'); ?> <i class="fa fa-user-circle" aria-hidden="true"></i>
<span class="caret"></span></a>
<ul class="dropdown-menu">
<li><a href="admin.php?q=appointments">All Appointments</a></li>
<li><a href="admin.php#section1">Update Profile</a></li>
...
<div class="sideInner">
  <ul class="sidebar-ul">
    <li><a href="admin.php#section1">Profile</a></li>
    <!--<li><a href="#section2">Date Scheduler</a></li> -->
    <li><a href="admin.php#section3">Time Scheduler</a></li>
    <li><a href="admin.php?q=appointments">All Appointments</a></li>
  </ul>
</div>
</div>
...
<!--all basic info close-->
<!-- Date Scheduler start-->
<!--
<div id="section2" class="col-sm-8 ver-line sce-step">
<h3 class="text-center admin-head">Date Scheduler</h3>
<div class="col-sm-6">
<div class="form-group">
<label>From</label>
<select id="dates" class="form-control" name="shedule">
<option value="today">Today</option>
<option value="tomorrow">Tomorrow</option>
<option id="fillDate" value="filldate">Fill Date</option>
</select>
</div>
<div class="form-group">
<input type="text" class="form-control fillDate" id="datepicker" name="fill_date" placeholder="Fill the Date">
</div>
</div>
<div class="col-sm-6">
<label>To</label>
...
<option value="Tomorrow">6 Month</option>
<option value="fillDate">1 Year</option>
<option value="fillDate">2 Year</option>
</select>
</div>
</div> -->
<!-- Date Scheduler close-->
