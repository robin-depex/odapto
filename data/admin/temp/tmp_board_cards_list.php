...
<div class="col-md-8 pull-right">
  <div class="col col-xs-6 pull-right">
    <a href="<?php echo $add_temp; ?>" class="btn btn-sm btn-primary btn-create"><span class="fa fa-plus"></span>Add New Template Board Card</a>
  </div>
</div>
</div>
</div>
...
<h4 class="title">Template Board Cards List</h4>
<p class="category">Odapto Template Board Card Lists</p>
</div>
        ...
        $.ajax({
            ...
            success:function(res){
                ...
                $(".poptext").text(obj.message);
                  var url = "<?php echo "https://www.odapto.com/admin/dashboard.php?page=boardcards"; ?>";
