...
function fetch_user_last_activity($user_id, $connect)
{
    ...
    function get_name($user_id, $connect)
    {
...
function fetch_user_chat_history($from_user_id, $to_user_id, $connect)
{
	...
	foreach($result as $row)
	{
		...
		{
			$user_name = '<b class="text-success ">'.get_user_name($row['from_user_id'], $connect).'</b>';
			$bg='#ffc';
			
		}
		$output .= '
		<li style="border-bottom:1px dotted #ccc;background:'.$bg.'; padding-left:5px; padding-top:7px; border-radius: 12px;">
