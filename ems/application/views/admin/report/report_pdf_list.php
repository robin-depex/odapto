	...
	$output .= '
				...
				<table width="100%" style="">
						...
						<tr align="center" style=" background-color:#DEDEDE;color:#000;font-size:12px;font-weight:900;">
							...
							<td width="15%">Book Person</td>
							<td width="43%">Booking List</td>	
						</tr>';
						...
						$i++;
                           $output .='<tr>
                              ...
                              <td align="center">'. date('d-m-Y',strtotime($_date->booking_date)).'</td>
                              <td align="center">
                               '. $total_order = $CI->get_total_order($_date->event_id,$_date->booking_date)
                                .'
                              </td>';
...
$pdf->Output('Report_DateWise.pdf', 'I');
